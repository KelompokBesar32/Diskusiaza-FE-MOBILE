...
class ProfileDetailScreen2 extends StatefulWidget {
  const ProfileDetailScreen2({Key? key}) : super(key: key);

  @override
  State<ProfileDetailScreen2> createState() => _ProfileDetailScreen2State();
}

class _ProfileDetailScreen2State extends State<ProfileDetailScreen2> {
  @override
  void initState() {
    super.initState();
