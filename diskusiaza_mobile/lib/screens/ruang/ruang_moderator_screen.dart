...
class RuangModeratorScreen extends StatelessWidget {
  const RuangModeratorScreen({Key? key}) : super(key: key);
                    ...
                    background: Column(
                      children: [
                        ...
                        ListTile(
                          ...
                          subtitle: Text(
                            '@Ruang untuk para jomblo yang ngakunya single',
